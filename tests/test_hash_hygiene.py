...
def test_receipt_core_extraction():
    ...
    full_receipt = {
        ...
        "content": {"step_type": "TEST", "risk_delta_q": "1000"},
        "metadata": {"created_at": "2024-01-01", "custom_field": "keep_this"},
        "version": "1.0.0",
    }
...
def test_genesis_digest():
    ...
    assert not is_genesis(
        "sha256:aaaa1111222233334444555556666777788889999aaaabbbbccccddddeeeeffff"
    )
