...
class TestTypeRegistry(unittest.TestCase):
    ...
    def test_create_struct(self):
        ...
        struct = registry.create_struct(name="Point", fields={"x": "int", "y": "int"})
    ...
    def test_create_union(self):
        ...
        union = registry.create_union(name="Number", variants=["int", "float"])
...
class TestTypeEdgeCases(unittest.TestCase):
    ...
    def test_self_referential_struct(self):
        ...
        node_struct = StructType(fields={"value": IntType(), "next": node_type})
