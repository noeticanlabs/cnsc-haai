...
class TestFullPipeline(unittest.TestCase):
    ...
    def test_ghll_parse_to_nsc(self):
        ...
        func = create_nsc_function(name="main", param_types=[], return_type=NSCType.INT)
    ...
    def test_trace_and_replay(self):
        ...
        result = engine.execute_replay("replay-test", executor, checkpoints=[checkpoint])
...
class TestSeamContracts(unittest.TestCase):
    ...
    def test_ghll_nsc_lowering(self):
        ...
        func = create_nsc_function(name="lowered_func", param_types=None, return_type=NSCType.INT)
        program.add_function(func)
...
class TestGoldenArtifacts(unittest.TestCase):
    ...
    def test_bytecode_roundtrip(self):
        ...
        func = create_nsc_function(name="test_func", param_types=[], return_type=NSCType.INT)
        program.add_function(func)
