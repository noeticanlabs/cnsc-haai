...
class GraphBuilder:
    ...
    def begin_commit(self, commit_id: str, operation: str = "unknown", **kwargs) -> "GraphBuilder":
        """
        Start a commit node.
    ...
    def add_state(self, state_id: str, state_type: str = "unknown", **kwargs) -> "GraphBuilder":
        """
        Add a state node.
    ...
    def add_candidate(self, candidate_id: str, value: Any, **kwargs) -> "GraphBuilder":
        """
    ...
    def add_constraint_set(
        self, constraint_id: str, constraints: list[Any] = None, **kwargs
    ) -> "GraphBuilder":
        """
    ...
    def add_gate_stack_run(
        self, run_id: str, gate_sequence: list[str] = None, **kwargs
    ) -> "GraphBuilder":
        """
    ...
    def add_gate_result(
        self, result_id: str, gate_type: str, passed: bool, **kwargs
    ) -> "GraphBuilder":
        """
    ...
    def add_proof_bundle(
        self, bundle_id: str, proof_type: str = "unknown", **kwargs
    ) -> "GraphBuilder":
        """
    ...
    def add_emit(
        self, emit_id: str, emit_type: str = "unknown", value: Any = None, **kwargs
    ) -> "GraphBuilder":
        """
        Add an emit node.
    ...
    def add_memory_read(self, read_id: str, address: Any, **kwargs) -> "GraphBuilder":
        """
    ...
    def add_memory_write(self, write_id: str, address: Any, value: Any, **kwargs) -> "GraphBuilder":
        """
    ...
    def add_solver_call(
        self, call_id: str, solver_type: str = "unknown", **kwargs
    ) -> "GraphBuilder":
        """
