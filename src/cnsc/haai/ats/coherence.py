"""
================================================================================
NON-CONSENSUS MODULE (Per Gap J: Coherence Firewall)
================================================================================
...
- Any consensus-critical code

For ATS kernel coherence, use:
- src/cnsc/haai/ats/risk.py (deterministic, fixed-point)
- src/cnsc/haai/ats/budget.py (budget law enforcement)
- src/cnsc/haai/ats/numeric.py (QFixed arithmetic)

================================================================================

Coherence Budget System - UI Heuristics

This module provides coherence tracking and budget management for non-consensus
UI purposes:
...
NOTE: This module uses Python floats and is NOT deterministic.
It is only for display/UI purposes, not for consensus verification.
...
class VectorResidual:
    ...
    NOTE: This uses Python float arithmetic and is NOT deterministic.
    For consensus use, see cnsc.haai.ats.risk for deterministic coherence.
    """
...
class CoherenceBudget:
    """
    Manages coherence budget for reasoning (UI/non-consensus).
    ...
    NOTE: This is a UI heuristic module. For consensus-critical coherence
    tracking, use cnsc.haai.ats.risk and cnsc.haai.ats.budget.
    ...
    def residual(self) -> VectorResidual:
        ...
        return VectorResidual(dynamical=self.dynamical_residual, clock=self.clock_residual)
