...
def verify_inclusion_proof(leaf_bytes: bytes, proof: List[Tuple[str, str]], root: bytes) -> bool:
    """
...
def verify_inclusion_proof_prefixed(leaf_bytes: bytes, proof: List[dict], root) -> bool:
    """
