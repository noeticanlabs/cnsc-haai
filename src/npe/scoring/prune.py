...
def _get_non_dominated(candidates: List[Any]) -> List[Any]:
    ...
    for i, c1 in enumerate(candidates):
        ...
        for c2 in candidates:
            ...
            if (
                c2.scores.risk <= c1.scores.risk
                and c2.scores.utility >= c1.scores.utility
                and c2.scores.cost <= c1.scores.cost
                and c2.scores.confidence >= c1.scores.confidence
                and (
                    c2.scores.risk < c1.scores.risk
                    or c2.scores.utility > c1.scores.utility
                    or c2.scores.cost < c1.scores.cost
                    or c2.scores.confidence > c1.scores.confidence
                )
            ):
                is_dominated = True
                break
